    ...
    public   void CREATEUSER(){
        ...
        firebaseAuth.createUserWithEmailAndPassword(E , P).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                ...
                UserClass userClass = new UserClass(E , P , UserID ,  firstname.getText().toString() , lastname.getText().toString() , contact.getText().toString() , address.getText().toString() , bloodgrouop.getText().toString() );
